...
_CURRENTLY HEAVILY WIP. I'm working towards a suitable 1.0 release that supports everything I want to support, and I decided I'd do that in master from now. That means that the docs below might not be accurate while I finish up the work around the first real release._
