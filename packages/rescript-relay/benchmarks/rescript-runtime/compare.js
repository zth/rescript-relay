...
const baseline = require("../../src/utils");
...
if (!process.argv[2]) {
  throw new Error("Usage: node benchmarks/rescript-runtime/compare.js <output.json>");
}
...
const report = {
  ...
  sha256: {
    baseline: hash("../../src/utils"),
    preparedBaseline: hash("../../src/prepareConversion"),
    candidate: hash("./output/utils.cjs"),
