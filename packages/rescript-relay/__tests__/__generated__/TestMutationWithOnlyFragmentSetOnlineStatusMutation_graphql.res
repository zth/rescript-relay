...
module Internal = {
  ...
  let wrapRawResponseConverter: Js.Dict.t<Js.Dict.t<Js.Dict.t<string>>> = %raw(
    json`{"__root":{"setOnlineStatus_user_onlineStatus":{"n":""},"setOnlineStatus_user_memberOf":{"u":"rawResponse_setOnlineStatus_user_memberOf","na":"","n":""},"setOnlineStatus_user":{"n":""},"setOnlineStatus":{"n":""}}}`
  )
