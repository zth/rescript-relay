...
module Types = {
  ...
  type rec response_setOnlineStatus = {user: option<response_setOnlineStatus_user>}
  and response_setOnlineStatus_user = RescriptRelay.allFieldsMasked
  and rawResponse_setOnlineStatus = {user: option<rawResponse_setOnlineStatus_user>}
...
module Internal = {
  ...
  let convertWrapRawResponse = v =>
    v->RescriptRelay.convertObj(wrapRawResponseConverter, wrapRawResponseConverterMap, Js.null)
  type rawResponseRaw
  ...
  let convertRawResponse = v =>
    v->RescriptRelay.convertObj(rawResponseConverter, rawResponseConverterMap, Js.undefined)
...
module Utils = {
  ...
  let make_rawResponse_setOnlineStatus = (~user=?, ()): rawResponse_setOnlineStatus => {
    user: user,
  }
  let make_response_setOnlineStatus_user = () => Js.Obj.empty()
