...
module Internal = {
  ...
  %%private(
  @live
  let fragmentConverter: JSON.t = %raw(json`{"roots":{"__root":[{"path":["createdAt"],"scalar":"0"}]},"version":2}`)
  @live
...
external getFragmentRef:
  array<RescriptRelay.fragmentRefs<[> | #TestConversionPlural_user]>> => fragmentRef = "%identity"
