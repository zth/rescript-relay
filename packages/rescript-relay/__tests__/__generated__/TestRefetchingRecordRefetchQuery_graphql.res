...
module Internal = {
  %%private(
  @live
  let variablesConverter: JSON.t = %raw(json`{"roots":{"__root":[{"path":["beforeDate"],"scalar":"TestsUtils.Datetime"},{"list":1,"path":["friendsOnlineStatuses"]},{"path":["number"],"scalar":"TestsUtils.Number"}]},"version":2}`)
  @live
