...
module Types = {
  ...
  type rec response_setOnlineStatusComplex = {user: option<response_setOnlineStatusComplex_user>}
  ...
  type response = {setOnlineStatusComplex: option<response_setOnlineStatusComplex>}
...
module Utils = {
  ...
  let make_response_setOnlineStatusComplex = (~user=?, ()): response_setOnlineStatusComplex => {
    user: user,
  }
