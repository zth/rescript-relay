...
module Internal = {
  ...
  %%private(
  @live
  let wrapResponseConverter: JSON.t = %raw(json`{"roots":{"__root":[{"fragments":true,"path":["loggedInUser"]},{"path":["loggedInUser","createdAt","value"],"scalar":"TestsUtils.Datetime"}]},"version":2}`)
  @live
