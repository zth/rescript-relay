/* @sourceLoc Test_missingFieldHandlersScalar.res */
/* @generated */
%%raw("/* @generated */")
module Types = {
  @@warning("-30")
...
module Internal = {
  ...
  %%private(
  @live
  let wrapResponseConverter: JSON.t = %raw(json`{"roots":{"__root":[{"path":["node"],"union":"response_node"}]},"version":2}`)
  @live
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "TestMissingFieldHandlersScalarQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "19729a4745ceacc5c197964e795a3581",
    "id": null,
    "metadata": {},
    "name": "TestMissingFieldHandlersScalarQuery",
    "operationKind": "query",
    "text": "query TestMissingFieldHandlersScalarQuery {\n  node(id: \"123\") {\n    __typename\n    ... on User {\n      surname\n    }\n    id\n  }\n}\n"
  }
};
})() `)
