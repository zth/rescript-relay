...
module Types = {
  ...
  type rec response_topOnlineUserList = {
    firstName: string,
  }
  type response = {
    topOnlineUserList: option<array<option<response_topOnlineUserList>>>,
  }
  @live
...
module Internal = {
  ...
  %%private(
  @live
  let wrapResponseConverter: JSON.t = %raw(json`{"roots":{"__root":[{"list":1,"path":["topOnlineUserList"]}]},"version":2}`)
  @live
...
return {
  ...
  "params": {
    "cacheID": "7235a6c5b815ac4487ca37815be4fef1",
    "id": null,
    "metadata": {},
    "name": "TestMissingFieldHandlersPluralQuery",
    "operationKind": "query",
    "text": "query TestMissingFieldHandlersPluralQuery {\n  topOnlineUserList {\n    firstName\n    id\n  }\n}\n"
  }
};
})() `)
