...
module Internal = {
  ...
  let variablesConverter: JSON.t = %raw(
    json`{"roots":{"__root":[{"path":["someInput"],"reference":"someInput"}],"someInput":[{"path":["datetime"],"scalar":"TestsUtils.Datetime"},{"path":["recursive"],"reference":"someInput"}]},"version":2}`
  )
  @live
