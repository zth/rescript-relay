...
module Types = {
  ...
  type rec response_member = {
    ...
    fragmentRefs: RescriptRelay.fragmentRefs<[ | #TestCatchUnionMember_member]>,
  }
  type response = {
...
module Internal = {
  ...
  let wrapResponseConverter: JSON.t = %raw(
    json`{"roots":{"__root":[{"fragments":true,"path":["member"]}]},"version":2}`
  )
  @live
...
return {
  ...
  "params": {
    "cacheID": "a370ac8d155ff1bf9c36c2e9e09ceb37",
    "id": null,
    "metadata": {},
    "name": "TestCatchUnionMemberQuery",
    "operationKind": "query",
    "text": "query TestCatchUnionMemberQuery {\n  member(id: \"123\") {\n    __typename\n    ...TestCatchUnionMember_member\n    ... on Node {\n      __isNode: __typename\n      __typename\n      id\n    }\n  }\n}\n\nfragment TestCatchUnionMember_member on Member {\n  __isMember: __typename\n  __typename\n  ... on User {\n    id\n    createdAt\n  }\n  ... on Group {\n    id\n    name\n  }\n}\n"
  }
};
})() `)
