...
module Types = {
  ...
  and response_member_HasNameComponent_hasName = {
    fragmentRefs: RescriptRelay.fragmentRefs<[ | #HasNameComponent_hasName]>,
  }
...
let node = RescriptRelay_Internal.applyCodesplitMetadata(node, [
  ("member.$$i$$HasName", () => {Js.import(HasNameComponent.make)->ignore}), 
