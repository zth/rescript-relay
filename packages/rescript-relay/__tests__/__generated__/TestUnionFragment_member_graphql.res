...
module Types = {
  ...
  type fragment = [#User(fragment_User) | #Group(fragment_Group) | #UnselectedUnionMember(string)]
}
...
type t
type fragmentRef
external getFragmentRef: RescriptRelay.fragmentRefs<[> #TestUnionFragment_member]> => fragmentRef =
  "%identity"
