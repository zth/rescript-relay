...
module Internal = {
  ...
  %%private(
  @live
  let wrapResponseConverter: JSON.t = %raw(json`{"roots":{"__root":[{"path":["member","value"],"union":"response_member_value"},{"path":["member","value","User","createdAt"],"scalar":"TestsUtils.Datetime"}]},"version":2}`)
  @live
